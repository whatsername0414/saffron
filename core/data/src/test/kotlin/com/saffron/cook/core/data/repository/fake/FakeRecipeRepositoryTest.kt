...
class FakeRecipeRepositoryTest {
    ...
    @Test
    fun `getRecipesByCategory filters by category id`() = runTest {
    ...
    fun `shouldThrow makes calls fail`() = runTest {
